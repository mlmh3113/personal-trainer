<template>
  <nav class="md:hidden bg-white border-gray-200 dark:bg-gray-900 dark:text-white">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <svg fill="currentColor" class="w-8" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 412.452 412.452" xml:space="preserve">
  ...
  <header class="flex flex-col justify-between items-center py-10 dark:bg-gray-900 dark:text-white">
    <div class="border-2 border-teal-500 p-7">
      <h1 class="text-center text-9xl uppercase tracking-widest">Get Fit!</h1>
    </div>
    <p class="text-4xl -m-6 bg-white px-4 cursive text-teal-500 dark:bg-gray-900">personal trainer</p>
  </header>

  <nav class="hidden md:flex justify-center gap-10 py-10 dark:bg-gray-900 dark:text-white">


    <RouterLink class="uppercase text-2xl hover:text-teal-500 hover:underline" to="#">About</RouterLink>
    <RouterLink class="uppercase text-2xl hover:text-teal-500 hover:underline" to="#">services</RouterLink>
    <RouterLink class="uppercase text-2xl hover:text-teal-500 hover:underline" to="#">packages</RouterLink>
    <RouterLink class="uppercase text-2xl hover:text-teal-500 hover:underline" to="#">resources</RouterLink>
    <RouterLink class="uppercase text-2xl hover:text-teal-500 hover:underline" to="#">blog</RouterLink>
    <RouterLink class="uppercase text-2xl hover:text-teal-500 hover:underline" to="#">contact</RouterLink>
